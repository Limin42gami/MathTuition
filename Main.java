...
public class Main {
    public static void main(String[] args) {
        ...
        // Create two teachers
        Teacher teacher1 = new Teacher(new Name("Deli", "A", "Min"), "1234567890", "123 Main St.", 10, "M.Ed.");
        Teacher teacher2 = new Teacher(new Name("Waj", "D", "Man"), "0987654321", "456 High St.", 5, "B.Ed.");
        ...
        Student student1 = new Student(new Name("Adli", "Amin", "Zambri"), "1234567890", "789 Elm St.", "ABC School");
        ...
        Student student2 = new Student(new Name("Mat", "Nor", "Zambri"), "0987654321", "321 Oak St.", "XYZ School");
        ...
        Student student3 = new Student(new Name("Zambri", "Zakaria", "Putih"), "4567890123", "456 Maple St.", "DEF School");
        ...
        Student student4 = new Student(new Name("Ash", "F", "Mike"), "7890123456", "567 Pine St.", "GHI School");
        ...
        Student student5 = new Student(new Name("Kupo", "N", "Ofer"), "2345678901", "789 Elm St.", "ABC School");
        ...
        Student student6 = new Student(new Name("Ningg", "G", "Goh"), "3456789012", "123 Oak St.", "XYZ School");
        ...
        System.out.println("Average mark: " + student1.getAvgMark());
        System.out.println("Average mark: "+ student4.getAvgMark());
